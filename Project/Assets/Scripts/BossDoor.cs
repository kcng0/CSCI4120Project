...
public class BossDoor : Interactable
{
    ...
    public override string GetDescription() {
        ...
        if (locked == true) {
            return "You need to slay the boss first";
        }
        else if (locked == false && open == false && item != null && item == key) {
                return "Press E to open the door!";
            } else if (locked == false && open == true && item != null && item == key) {
    ...
    public override void Interact() {
        if (item != null && item == key && locked == false) {
            ChangeDoorState();
        }
    }
